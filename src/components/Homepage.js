...
const Homepage = () => {
    ...
    return (
        <div className="bg-gradient-to-b from-[#030701] to-[#113402] m-0 p-0  w-auto">
            ...
            {/* Electripe Icon */}
            <div className='flex w-40 md:w-50 justify-start mt-8 ml-6'>
            ...
            <div className='bg-gradient-to-b from-[#030701] to-[#113402] flex md:justify-between justify- flex-col justify-center items-center pt-8 pl-5 pr-5 md:pr-20 md:pl-20'>
                ...
                <div className='flex flex-col mb-6 md:mt-6 bg-gradient-to-b from-[#113402] to-[#030701]'>
                    ...
                    <a className='flex justify-center items-center m-4 bg-[#00A878] p-1 py-3'>
            ...
            < div className='flex flex-col bg-gradient-to-b from-[#113402] to-[#030701] pl-5 pr-5 md:pr-20 md:pl-20 md: pt-8 items-center' >
                ...
                <div className='bg-black-200 w-full md:w-1/3 py-2 border-2 border-gray-800 mb-4'>
            ...
            <div className='bg-gradient-to-b from-[#030701] to-[#0B2101] pl-5 pr-5 pt-4 md:pr-20 md:pl-20 pb-5 '>
                <div className='flex flex-col bg-gradient-to-b from-[#113402] to-[#030701] pl-4 pr-4 md:pr-20 md:pl-20 pb-5  justify-center items-center' >
                    ...
                    <a className='flex justify-center items-center bg-[#00A878] p-2 py-3 mt-4 mx-4 w-full'>
            ...
            <div className='bg-gradient-to-b px-4 from-[#0B2101] to-[#030701]'>


                <div div className='flex flex-col' >
                    <div className='my-4'><p className='text-white font-semibold text-2xl'>
                        <span className='text-[#00A878]'>And thousands of Indians </span> <br/>
                        who believe in us</p>
                    </div>
                    <div>
                            <VideoCarousel/>
                ...
                <div className='flex flex-col md:pr-20 md:pl-20 w-auto'>
                    <div>
                        <p className='text-white text-2xl md:text-4xl font-bold pt-5'> In News</p>
                    </div>

                    <div className='w-full h-28 md:h-96'>
                        <div className='flex mt-4 mr-10 snap-x mx-auto w-full h-28 md:h-80 overflow-scroll'>
                            <div className='w-72 h-24 md:h-80 px-3 py-4 flex items-center flex-shrink-0 justify-center bg-[#090D08] m-2 mr-3 snap-start bg-gradient-to-b from-[#113402] to-[#0C2302]'>
                                ...
                                <img className='w-5 ml-1 -mt-4' src={rightArrow} />
                            </div>
                ...
                <div div className='flex flex-col md:pr-20 md:pl-20 w-auto'>
                    <div>
                        <p className='text-white text-2xl md:text-4xl font-bold pt-5'>Learn from our blogs</p>
                    </div>

                    <div className='flex items-center mt-4 snap-x mx-auto w-80 overflow-scroll'>
                        <div className='flex flex-col my-1 w-72 flex-shrink-0 snap-start mx-2 bg-gradient-to-b from-[#113302] to-[#0D2402]'>
                            <div className='h-40 bg-[#ffffff] opacity-10'></div>
                            <div className='bg-gradient-to-b from-[#113302] to-[#0D2402] py-1'><p className='text-white text-1xl font-semibold font-inter text-start p-3'>Safety First Station For All</p></div>
                        </div>
                        <div className='flex flex-col my-1 w-72 flex-shrink-0 snap-start mx-2 bg-gradient-to-b from-[#113302] to-[#0D2402]'>
                            <div className='h-40 bg-[#ffffff] opacity-10'></div>
                            <div className='bg-gradient-to-b from-[#113302] to-[#0D2402] py-1'><p className='text-white text-1xl font-semibold font-inter text-start p-3'>Safety First Station For All</p></div>
                        ...
                        <div className='flex flex-col my-1 w-72 flex-shrink-0 snap-start mx-2 bg-gradient-to-b from-[#113302] to-[#0D2402]'>
                            ...
                            {/* Footer */}
            <div div className='py-8 flex flex-col bg-[#0000]' >
